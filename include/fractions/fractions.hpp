...
namespace fractions {
    ...
    template <typename T> struct Fraction {
        ...
        /**
         * Constructs a new Fraction (Extended Fraction) object from the given numerator and
         * denominator.
         *
         ...
         * @return Stream&
         */
        template <typename Stream> friend auto operator<<(Stream& out_stream, const Fraction& frac)
            -> Stream& {
