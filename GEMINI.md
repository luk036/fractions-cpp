...
This is a C++ project that implements a fraction library. It uses modern CMake practices for building, testing, and dependency management. The core of the project is a single-header library, `extfractions.hpp`, which provides a `ExtFraction` class with support for arithmetic and comparison operations.
