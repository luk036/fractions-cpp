...
This is a C++ library project called **fractions-cpp** that provides a Fraction class for handling rational numbers. The library allows operations with fractions, including addition, subtraction, multiplication, division, comparison, and more. It supports special cases like allowing zero denominators and handles various numeric types.
...
- `include/fractions/fractions.hpp` - Main header file containing the Fraction class template and related functions (gcd, lcm, abs)
...
### Tests
- `test/source/test_frac.cpp` - Main test file with comprehensive tests for Fraction operations
...
- Zero denominators are allowed in the Fraction class
